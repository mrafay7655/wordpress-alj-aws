...
namespace WP_Grid_Builder_Multilingual;
 ...
 * Autoload class.
 *
 * @class WP_Grid_Builder_Multilingual\Autoload
 * @since 1.0.0
 */
class Autoload {
...
$loader->add_namespace( 'WP_Grid_Builder_Multilingual', WPGB_MULTILINGUAL_PATH );
